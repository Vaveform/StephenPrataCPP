...
Cow::Cow() : weight(0) {
	...
	std::strcpy(this->hobby, "No hobby");
}
...
Cow::Cow(const Cow& c) : weight(c.weight){
	std::cout << "Working copy constructor for " << (void*) this 
		<< " with object " << (void*) &c<< std::endl;
...
Cow& Cow::operator=(const Cow& c){
	std::cout << "Working assignment operator for " << (void*) this 
		<< " with right side " << (void*)&c << std::endl;
...
void Cow::ShowCow() const{
	std::cout << "Object " << (void*)this << std::endl;
